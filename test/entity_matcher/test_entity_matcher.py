...
class TestEntityMatcherString:
    ...
    def test_matched_entities(self, processed_docs) -> None:
        ...
        assert "http://www.msesboue.org/o/pizza-data-demo/bisou#_godSaveTheKing" in matched_ents
        assert "http://www.msesboue.org/o/pizza-data-demo/bisou#_tomatoBase" in matched_ents
        assert "http://www.msesboue.org/o/pizza-data-demo/bisou#_mozzaFiorDiLatte" in matched_ents